...
{
    public class SquareColumnsReinforcementT6 : IExternalCommand
    {
            ...
            , SquareColumnsReinforcementWPF squareColumnsReinforcementWPF)
        {
            ...
            double secondTopRebarOffset = squareColumnsReinforcementWPF.SecondTopRebarOffset / 304.8;
            double secondLowerRebarOffset = squareColumnsReinforcementWPF.SecondLowerRebarOffset / 304.8;
            double secondLeftRebarOffset = squareColumnsReinforcementWPF.SecondLeftRebarOffset / 304.8;
            double secondRightRebarOffset = squareColumnsReinforcementWPF.SecondRightRebarOffset / 304.8;
            ...
            using (Transaction t = new Transaction(doc))
            {
                ...
                foreach (FamilyInstance column in columnsList)
                {
                        ...
                        && squareColumnsReinforcementWPF.BendInSlabChecked == false)
                    {
                        ...
                        //Центральный левый нижний стержень1
                        ...
                        //Центральный левый верхний стержень1
                        ...
                        //Центральный левый нижний стержень2
                        Rebar columnMainRebar_1C = Rebar.CreateFromCurvesAndShape(doc
                            , form26
                            , secondMainBarTape
                            , null
                            , null
                            ...
                            , RebarHookOrientation.Right
                            , RebarHookOrientation.Right);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_1C.Id, rotateLine, 90 * (Math.PI / 180));
                        XYZ newPlaсeСolumnMainRebar_1C = new XYZ(-columnProperty.ColumnSectionHeight / 2 + coverDistance + secondMainBarDiam / 2, -firstLowerRebarOffset - secondLowerRebarOffset, 0);
                        ElementTransformUtils.MoveElement(doc, columnMainRebar_1C.Id, newPlaсeСolumnMainRebar_1C);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_1C.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);

                        //Центральный левый верхний стержень2
                        Rebar columnMainRebar_1D = Rebar.CreateFromCurvesAndShape(doc
                            , form26
                            , secondMainBarTape
                            , null
                            , null
                            ...
                            , RebarHookOrientation.Right
                            , RebarHookOrientation.Right);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_1D.Id, rotateLine, 90 * (Math.PI / 180));
                        XYZ newPlaсeСolumnMainRebar_1D = new XYZ(-columnProperty.ColumnSectionHeight / 2 + coverDistance + secondMainBarDiam / 2, firstTopRebarOffset + secondTopRebarOffset, 0);
                        ElementTransformUtils.MoveElement(doc, columnMainRebar_1D.Id, newPlaсeСolumnMainRebar_1D);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_1D.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);


                        //Центральный правый нижний стержень1
                        ...
                        //Центральный правый верхний стержень1
                        ...
                        //Центральный правый нижний стержень2
                        Rebar columnMainRebar_2C = Rebar.CreateFromCurvesAndShape(doc
                            , form26
                            , secondMainBarTape
                            , null
                            , null
                        ...
                        XYZ newPlaсeСolumnMainRebar_2C = new XYZ(+columnProperty.ColumnSectionHeight / 2 - coverDistance - secondMainBarDiam / 2, -firstLowerRebarOffset - secondLowerRebarOffset, 0);
                        ...
                        //Центральный правый верхний стержень2
                        Rebar columnMainRebar_2D = Rebar.CreateFromCurvesAndShape(doc
                            , form26
                            , secondMainBarTape
                            , null
                            , null
                            ...
                            , RebarHookOrientation.Right
                            , RebarHookOrientation.Right);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_2D.Id, rotateLine, 90 * (Math.PI / 180));
                        XYZ newPlaсeСolumnMainRebar_2D = new XYZ(+columnProperty.ColumnSectionHeight / 2 - coverDistance - secondMainBarDiam / 2, firstTopRebarOffset + secondTopRebarOffset, 0);
                        ElementTransformUtils.MoveElement(doc, columnMainRebar_2D.Id, newPlaсeСolumnMainRebar_2D);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_2D.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);


                        //Центральный нижний левый стержень1
                        ...
                        //Центральный нижний правый стержень1
                        ...
                        //Центральный нижний левый стержень2
                        Rebar columnMainRebar_3C = Rebar.CreateFromCurvesAndShape(doc
                            , form26
                            , secondMainBarTape
                            , null
                            , null
                            ...
                            , RebarHookOrientation.Right
                            , RebarHookOrientation.Right);
                        XYZ newPlaсeСolumnMainRebar_3C = new XYZ(-firstLeftRebarOffset - secondLeftRebarOffset, -columnProperty.ColumnSectionWidth / 2 + coverDistance + secondMainBarDiam / 2, 0);
                        ElementTransformUtils.MoveElement(doc, columnMainRebar_3C.Id, newPlaсeСolumnMainRebar_3C);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_3C.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);

                        //Центральный нижний правый стержень2
                        Rebar columnMainRebar_3D = Rebar.CreateFromCurvesAndShape(doc
                            , form26
                            , secondMainBarTape
                            , null
                            , null
                            ...
                            , RebarHookOrientation.Right
                            , RebarHookOrientation.Right);
                        XYZ newPlaсeСolumnMainRebar_3D = new XYZ(firstRightRebarOffset + secondRightRebarOffset, -columnProperty.ColumnSectionWidth / 2 + coverDistance + secondMainBarDiam / 2, 0);
                        ElementTransformUtils.MoveElement(doc, columnMainRebar_3D.Id, newPlaсeСolumnMainRebar_3D);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_3D.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);


                        //Центральный верхний левый стержень1
                        ...
                        //Центральный верхний правый стержень1
                        ...
                        //Центральный верхний левый стержень2
                        Rebar columnMainRebar_4C = Rebar.CreateFromCurvesAndShape(doc
                            , form26
                            , secondMainBarTape
                            , null
                            , null
                            ...
                            , RebarHookOrientation.Right
                            , RebarHookOrientation.Right);
                        XYZ newPlaсeСolumnMainRebar_4C = new XYZ(-firstLeftRebarOffset - secondLeftRebarOffset, columnProperty.ColumnSectionWidth / 2 - coverDistance - secondMainBarDiam / 2, 0);
                        ElementTransformUtils.MoveElement(doc, columnMainRebar_4C.Id, newPlaсeСolumnMainRebar_4C);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_4C.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);

                        //Центральный верхний правый стержень2
                        Rebar columnMainRebar_4D = Rebar.CreateFromCurvesAndShape(doc
                            , form26
                            , secondMainBarTape
                            , null
                            , null
                            ...
                            , RebarHookOrientation.Right
                            , RebarHookOrientation.Right);
                        XYZ newPlaсeСolumnMainRebar_4D = new XYZ(firstRightRebarOffset + secondRightRebarOffset, columnProperty.ColumnSectionWidth / 2 - coverDistance - secondMainBarDiam / 2, 0);
                        ElementTransformUtils.MoveElement(doc, columnMainRebar_4D.Id, newPlaсeСolumnMainRebar_4D);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_4D.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                    }
                        ...
                        && squareColumnsReinforcementWPF.BendInSlabChecked == true)
                    {
                        ...
                        Rebar columnMainRebar_1C = Rebar.CreateFromCurvesAndShape(doc
                            ...
                            , RebarHookOrientation.Right
                            , RebarHookOrientation.Right);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_1C.Id, rotateLine, 180 * (Math.PI / 180));
                        XYZ newPlaсeСolumnMainRebar_1C = new XYZ(-columnProperty.ColumnSectionHeight / 2 + coverDistance + secondMainBarDiam / 2, -firstLowerRebarOffset - secondLowerRebarOffset, 0);
                        ElementTransformUtils.MoveElement(doc, columnMainRebar_1C.Id, newPlaсeСolumnMainRebar_1C);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_1C.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        Rebar columnMainRebar_1D = Rebar.CreateFromCurvesAndShape(doc
                            ...
                            , RebarHookOrientation.Right
                            , RebarHookOrientation.Right);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_1D.Id, rotateLine, 180 * (Math.PI / 180));
                        XYZ newPlaсeСolumnMainRebar_1D = new XYZ(-columnProperty.ColumnSectionHeight / 2 + coverDistance + secondMainBarDiam / 2, firstTopRebarOffset + secondTopRebarOffset, 0);
                        ElementTransformUtils.MoveElement(doc, columnMainRebar_1D.Id, newPlaсeСolumnMainRebar_1D);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_1D.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_3C.Id, rotateLine, -90 * (Math.PI / 180));
                        XYZ newPlaсeСolumnMainRebar_3C = new XYZ(-firstLeftRebarOffset - secondLeftRebarOffset, -columnProperty.ColumnSectionWidth / 2 + coverDistance + secondMainBarDiam / 2, 0);
                        ElementTransformUtils.MoveElement(doc, columnMainRebar_3C.Id, newPlaсeСolumnMainRebar_3C);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_3C.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_3D.Id, rotateLine, -90 * (Math.PI / 180));
                        XYZ newPlaсeСolumnMainRebar_3D = new XYZ(firstRightRebarOffset + secondRightRebarOffset, -columnProperty.ColumnSectionWidth / 2 + coverDistance + secondMainBarDiam / 2, 0);
                        ElementTransformUtils.MoveElement(doc, columnMainRebar_3D.Id, newPlaсeСolumnMainRebar_3D);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_3D.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_4C.Id, rotateLine, 90 * (Math.PI / 180));
                        XYZ newPlaсeСolumnMainRebar_4C = new XYZ(-firstLeftRebarOffset - secondLeftRebarOffset, columnProperty.ColumnSectionWidth / 2 - coverDistance - secondMainBarDiam / 2, 0);
                        ElementTransformUtils.MoveElement(doc, columnMainRebar_4C.Id, newPlaсeСolumnMainRebar_4C);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_4C.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_4D.Id, rotateLine, 90 * (Math.PI / 180));
                        XYZ newPlaсeСolumnMainRebar_4D = new XYZ(firstRightRebarOffset + secondRightRebarOffset, columnProperty.ColumnSectionWidth / 2 - coverDistance - secondMainBarDiam / 2, 0);
                        ElementTransformUtils.MoveElement(doc, columnMainRebar_4D.Id, newPlaсeСolumnMainRebar_4D);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_4D.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                    }
                        ...
                        && squareColumnsReinforcementWPF.BendInSlabChecked == false)
                    {
                        ...
                        Curve line1S = Line.CreateBound(rebar_p1L, rebar_p2L) as Curve;
                        mainRebarCurvesL.Add(line1S);

                        //Кривые основных укороченных стержней
                        List<Curve> mainRebarCurvesS = new List<Curve>();
                        Curve secondMainLine1 = Line.CreateBound(rebar_p1S, rebar_p2S) as Curve;
                        mainRebarCurvesS.Add(secondMainLine1);
                        ...
                        FamilyInstance mechanicalConnection_1A = doc.Create.NewFamilyInstance(mechanicalConnection_p0L
                        ...
                        FamilyInstance mechanicalConnection_1B = doc.Create.NewFamilyInstance(mechanicalConnection_p0S
                            , secondMechanicalConnectionFamilySymbol
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        ...
                        FamilyInstance mechanicalConnection_1C = doc.Create.NewFamilyInstance(mechanicalConnection_p0S
                            , secondMechanicalConnectionFamilySymbol
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        ElementTransformUtils.MoveElement(doc, mechanicalConnection_1C.Id, newPlaсeСolumnMainRebar_1C);
                        ElementTransformUtils.RotateElement(doc, mechanicalConnection_1C.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        FamilyInstance mechanicalConnection_1D = doc.Create.NewFamilyInstance(mechanicalConnection_p0L
                            , secondMechanicalConnectionFamilySymbol
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        ElementTransformUtils.MoveElement(doc, mechanicalConnection_1D.Id, newPlaсeСolumnMainRebar_1D);
                        ElementTransformUtils.RotateElement(doc, mechanicalConnection_1D.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        FamilyInstance mechanicalConnection_2B = doc.Create.NewFamilyInstance(mechanicalConnection_p0L
                            , secondMechanicalConnectionFamilySymbol
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        ...
                        FamilyInstance mechanicalConnection_2C = doc.Create.NewFamilyInstance(mechanicalConnection_p0L
                            , secondMechanicalConnectionFamilySymbol
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        ElementTransformUtils.MoveElement(doc, mechanicalConnection_2C.Id, newPlaсeСolumnMainRebar_2C);
                        ElementTransformUtils.RotateElement(doc, mechanicalConnection_2C.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        FamilyInstance mechanicalConnection_2D = doc.Create.NewFamilyInstance(mechanicalConnection_p0S
                            , secondMechanicalConnectionFamilySymbol
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        ElementTransformUtils.MoveElement(doc, mechanicalConnection_2D.Id, newPlaсeСolumnMainRebar_2D);
                        ElementTransformUtils.RotateElement(doc, mechanicalConnection_2D.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        FamilyInstance mechanicalConnection_3A = doc.Create.NewFamilyInstance(mechanicalConnection_p0L
                            , secondMechanicalConnectionFamilySymbol
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        ...
                        FamilyInstance mechanicalConnection_3B = doc.Create.NewFamilyInstance(mechanicalConnection_p0S
                            , secondMechanicalConnectionFamilySymbol
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        ...
                        FamilyInstance mechanicalConnection_3C = doc.Create.NewFamilyInstance(mechanicalConnection_p0S
                            , secondMechanicalConnectionFamilySymbol
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        ElementTransformUtils.MoveElement(doc, mechanicalConnection_3C.Id, newPlaсeСolumnMainRebar_3C);
                        ElementTransformUtils.RotateElement(doc, mechanicalConnection_3C.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        FamilyInstance mechanicalConnection_3D = doc.Create.NewFamilyInstance(mechanicalConnection_p0L
                            , secondMechanicalConnectionFamilySymbol
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        ElementTransformUtils.MoveElement(doc, mechanicalConnection_3D.Id, newPlaсeСolumnMainRebar_3D);
                        ElementTransformUtils.RotateElement(doc, mechanicalConnection_3D.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        FamilyInstance mechanicalConnection_4B = doc.Create.NewFamilyInstance(mechanicalConnection_p0L
                            , secondMechanicalConnectionFamilySymbol
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        ...
                        FamilyInstance mechanicalConnection_4C = doc.Create.NewFamilyInstance(mechanicalConnection_p0L
                            , secondMechanicalConnectionFamilySymbol
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        ElementTransformUtils.MoveElement(doc, mechanicalConnection_4C.Id, newPlaсeСolumnMainRebar_4C);
                        ElementTransformUtils.RotateElement(doc, mechanicalConnection_4C.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        FamilyInstance mechanicalConnection_4D = doc.Create.NewFamilyInstance(mechanicalConnection_p0S
                            , secondMechanicalConnectionFamilySymbol
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        ElementTransformUtils.MoveElement(doc, mechanicalConnection_4D.Id, newPlaсeСolumnMainRebar_4D);
                        ElementTransformUtils.RotateElement(doc, mechanicalConnection_4D.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                    }
                        ...
                        && squareColumnsReinforcementWPF.SectionChangeChecked == true)
                    {
                        ...
                        Rebar columnMainRebar_1D = Rebar.CreateFromCurvesAndShape(doc
                            ...
                            , RebarHookOrientation.Right
                            , RebarHookOrientation.Right);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_1D.Id, rotateLine, alphaSecondOverlapping);
                        XYZ newPlaсeСolumnMainRebar_1D = new XYZ(-columnProperty.ColumnSectionHeight / 2 + coverDistance + secondMainBarDiam / 2, firstTopRebarOffset + secondTopRebarOffset, 0);
                        ElementTransformUtils.MoveElement(doc, columnMainRebar_1D.Id, newPlaсeСolumnMainRebar_1D);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_1D.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_2C.Id, rotateLine2, 180 * (Math.PI / 180));
                        XYZ newPlaсeСolumnRebar_2C = new XYZ(columnProperty.ColumnSectionHeight / 2 - coverDistance - secondMainBarDiam / 2, -firstLowerRebarOffset - secondLowerRebarOffset, 0);
                        ElementTransformUtils.MoveElement(doc, columnMainRebar_2C.Id, newPlaсeСolumnRebar_2C);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_2C.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        Rebar columnMainRebar_2D = Rebar.CreateFromCurvesAndShape(doc
                            ...
                            , RebarHookOrientation.Right
                            , RebarHookOrientation.Right);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_2D.Id, rotateLine, -alphaSecondOverlapping);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_2D.Id, rotateLine2, 180 * (Math.PI / 180));
                        XYZ newPlaсeСolumnRebar_2D = new XYZ(columnProperty.ColumnSectionHeight / 2 - coverDistance - secondMainBarDiam / 2, firstTopRebarOffset + secondTopRebarOffset, 0);
                        ElementTransformUtils.MoveElement(doc, columnMainRebar_2D.Id, newPlaсeСolumnRebar_2D);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_2D.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_3C.Id, rotateLine2, 90 * (Math.PI / 180));
                        XYZ newPlaсeСolumnRebar_3C = new XYZ(-firstLeftRebarOffset - secondLeftRebarOffset, -columnProperty.ColumnSectionWidth / 2 + coverDistance + secondMainBarDiam / 2, 0);
                        ElementTransformUtils.MoveElement(doc, columnMainRebar_3C.Id, newPlaсeСolumnRebar_3C);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_3C.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        Rebar columnMainRebar_3D = Rebar.CreateFromCurvesAndShape(doc
                            ...
                            , RebarHookOrientation.Right
                            , RebarHookOrientation.Right);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_3D.Id, rotateLine, -alphaSecondOverlapping);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_3D.Id, rotateLine2, 90 * (Math.PI / 180));
                        XYZ newPlaсeСolumnRebar_3D = new XYZ(firstRightRebarOffset + secondRightRebarOffset, -columnProperty.ColumnSectionWidth / 2 + coverDistance + secondMainBarDiam / 2, 0);
                        ElementTransformUtils.MoveElement(doc, columnMainRebar_3D.Id, newPlaсeСolumnRebar_3D);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_3D.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_4C.Id, rotateLine2, -90 * (Math.PI / 180));
                        XYZ newPlaсeСolumnRebar_4C = new XYZ(-firstLeftRebarOffset - secondLeftRebarOffset, columnProperty.ColumnSectionWidth / 2 - coverDistance - secondMainBarDiam / 2, 0);
                        ...
                        Rebar columnMainRebar_4D = Rebar.CreateFromCurvesAndShape(doc
                            ...
                            , RebarHookOrientation.Right
                            , RebarHookOrientation.Right);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_4D.Id, rotateLine, alphaSecondOverlapping);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_4D.Id, rotateLine2, -90 * (Math.PI / 180));
                        XYZ newPlaсeСolumnRebar_4D = new XYZ(firstRightRebarOffset + secondRightRebarOffset, columnProperty.ColumnSectionWidth / 2 - coverDistance - secondMainBarDiam / 2, 0);
                        ElementTransformUtils.MoveElement(doc, columnMainRebar_4D.Id, newPlaсeСolumnRebar_4D);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_4D.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                    }
                        ...
                        && squareColumnsReinforcementWPF.SectionChangeChecked == true)
                    {
                        ...
                        FamilyInstance mechanicalConnection_1C = doc.Create.NewFamilyInstance(mechanicalConnection_p0S
                            ...
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        XYZ newPlaсemechanicalConnection_1C = new XYZ(-columnProperty.ColumnSectionHeight / 2
                            + coverDistance
                            + secondMainBarDiam / 2
                            + sectionOffset
                            , -firstLowerRebarOffset
                            - secondLowerRebarOffset, 0);
                        ElementTransformUtils.MoveElement(doc, mechanicalConnection_1C.Id, newPlaсemechanicalConnection_1C);
                        ElementTransformUtils.RotateElement(doc, mechanicalConnection_1C.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        FamilyInstance mechanicalConnection_1D = doc.Create.NewFamilyInstance(mechanicalConnection_p0L
                            ...
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        XYZ newPlaсemechanicalConnection_1D = new XYZ(-columnProperty.ColumnSectionHeight / 2 + coverDistance + secondMainBarDiam / 2 + sectionOffset, firstTopRebarOffset + secondTopRebarOffset, 0);
                        ElementTransformUtils.MoveElement(doc, mechanicalConnection_1D.Id, newPlaсemechanicalConnection_1D);
                        ElementTransformUtils.RotateElement(doc, mechanicalConnection_1D.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        FamilyInstance mechanicalConnection_2C = doc.Create.NewFamilyInstance(mechanicalConnection_p0L
                            ...
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        XYZ newPlaсemechanicalConnection_2C = new XYZ(columnProperty.ColumnSectionHeight / 2 - coverDistance - secondMainBarDiam / 2 - sectionOffset, -firstLowerRebarOffset - secondLowerRebarOffset, 0);
                        ElementTransformUtils.MoveElement(doc, mechanicalConnection_2C.Id, newPlaсemechanicalConnection_2C);
                        ElementTransformUtils.RotateElement(doc, mechanicalConnection_2C.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        FamilyInstance mechanicalConnection_2D = doc.Create.NewFamilyInstance(mechanicalConnection_p0S
                            ...
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        XYZ newPlaсemechanicalConnection_2D = new XYZ(columnProperty.ColumnSectionHeight / 2 - coverDistance - secondMainBarDiam / 2 - sectionOffset, firstTopRebarOffset + secondTopRebarOffset, 0);
                        ElementTransformUtils.MoveElement(doc, mechanicalConnection_2D.Id, newPlaсemechanicalConnection_2D);
                        ElementTransformUtils.RotateElement(doc, mechanicalConnection_2D.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        FamilyInstance mechanicalConnection_3C = doc.Create.NewFamilyInstance(mechanicalConnection_p0S
                            ...
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        XYZ newPlaсemechanicalConnection_3C = new XYZ(-firstLeftRebarOffset - secondLeftRebarOffset, -columnProperty.ColumnSectionWidth / 2 + coverDistance + secondMainBarDiam / 2 + sectionOffset, 0);
                        ElementTransformUtils.MoveElement(doc, mechanicalConnection_3C.Id, newPlaсemechanicalConnection_3C);
                        ElementTransformUtils.RotateElement(doc, mechanicalConnection_3C.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        FamilyInstance mechanicalConnection_3D = doc.Create.NewFamilyInstance(mechanicalConnection_p0L
                            ...
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        XYZ newPlaсemechanicalConnection_3D = new XYZ(firstRightRebarOffset + secondRightRebarOffset, -columnProperty.ColumnSectionWidth / 2 + coverDistance + secondMainBarDiam / 2 + sectionOffset, 0);
                        ElementTransformUtils.MoveElement(doc, mechanicalConnection_3D.Id, newPlaсemechanicalConnection_3D);
                        ElementTransformUtils.RotateElement(doc, mechanicalConnection_3D.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                        ...
                        FamilyInstance mechanicalConnection_4C = doc.Create.NewFamilyInstance(mechanicalConnection_p0L
                            ...
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        XYZ newPlaсemechanicalConnection_4C = new XYZ(-firstLeftRebarOffset - secondLeftRebarOffset, columnProperty.ColumnSectionWidth / 2 - coverDistance - secondMainBarDiam / 2 - sectionOffset, 0);
                        ElementTransformUtils.MoveElement(doc, mechanicalConnection_4C.Id, newPlaсemechanicalConnection_4C);
                        ElementTransformUtils.RotateElement(doc, mechanicalConnection_4C.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);

                        //Центральный верхний стержень2
                        Rebar columnMainRebar_4D = Rebar.CreateFromCurvesAndShape(doc
                            , form26
                            , secondMainBarTape
                            , null
                        ...
                        FamilyInstance mechanicalConnection_4D = doc.Create.NewFamilyInstance(mechanicalConnection_p0S
                            ...
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        XYZ newPlaсemechanicalConnection_4D = new XYZ(firstRightRebarOffset + secondRightRebarOffset, columnProperty.ColumnSectionWidth / 2 - coverDistance - secondMainBarDiam / 2 - sectionOffset, 0);
                        ElementTransformUtils.MoveElement(doc, mechanicalConnection_4D.Id, newPlaсemechanicalConnection_4D);
                        ElementTransformUtils.RotateElement(doc, mechanicalConnection_4D.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                    }
