...
{
    public class SquareColumnsReinforcementT5 : IExternalCommand
    {
            ...
            using (Transaction t = new Transaction(doc))
            {
                ...
                foreach (FamilyInstance column in columnsList)
                {
                        ...
                        && squareColumnsReinforcementWPF.BendInSlabChecked == false)
                    {
                        ...
                        XYZ newPlaсeСolumnMainRebar_1C = new XYZ(-columnProperty.ColumnSectionHeight / 2 + coverDistance + secondMainBarDiam / 2, 0, 0);
                        ...
                        Rebar columnMainRebar_3C = Rebar.CreateFromCurvesAndShape(doc
                            ...
                            , RebarHookOrientation.Right
                            , RebarHookOrientation.Right);
                        XYZ newPlaсeСolumnMainRebar_3C = new XYZ(0, -columnProperty.ColumnSectionWidth / 2 + coverDistance + secondMainBarDiam / 2, 0);
                        ...
                        Rebar columnMainRebar_4C = Rebar.CreateFromCurvesAndShape(doc
                            ...
                            , RebarHookOrientation.Right
                            , RebarHookOrientation.Right);
                        XYZ newPlaсeСolumnMainRebar_4C = new XYZ(0, columnProperty.ColumnSectionWidth / 2 - coverDistance - secondMainBarDiam / 2, 0);
                    ...
                    {
                        //Точки для построения угловых стержней удлиненных
                        XYZ rebar_p1L = null;
                        XYZ rebar_p2L = null;
                        if (squareColumnsReinforcementWPF.DeepenRebarChecked)
                        {
                        ...
                        XYZ firstMainRebar_p3 = new XYZ(Math.Round(rebar_p2L.X + firstRebarOutletsLength - (floorThickness - bendInSlab - firstMainBarDiam / 2), 6), Math.Round(rebar_p2L.Y, 6), Math.Round(rebar_p2L.Z, 6));

                        //Точки для построения боковых стержней укороченных
                        XYZ rebar_p1S = null;
                        XYZ rebar_p2S = null;
                        if (squareColumnsReinforcementWPF.DeepenRebarChecked)
                        {
                        ...
                        Curve line1L = Line.CreateBound(rebar_p1L, rebar_p2L) as Curve;
                        mainFirstRebarCurvesL.Add(line1L);
                        Curve line2L = Line.CreateBound(rebar_p2L, firstMainRebar_p3) as Curve;
                        mainFirstRebarCurvesL.Add(line2L);
                        ...
                        && squareColumnsReinforcementWPF.BendInSlabChecked == false)
                    {
                        ...
                        FamilyInstance mechanicalConnection_1C = doc.Create.NewFamilyInstance(mechanicalConnection_p0L
                            , secondMechanicalConnectionFamilySymbol
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        ...
                        FamilyInstance mechanicalConnection_3C = doc.Create.NewFamilyInstance(mechanicalConnection_p0L
                            , secondMechanicalConnectionFamilySymbol
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        ...
                        && squareColumnsReinforcementWPF.SectionChangeChecked == true)
                    {
                        ...
                        XYZ newPlaсeСolumnMainRebar_1 = new XYZ(-columnProperty.ColumnSectionHeight /
                            2 + coverDistance
                            + firstMainBarDiam / 2
                            , -columnProperty.ColumnSectionWidth / 2
                            + coverDistance
                        ...
                        XYZ newPlaсeСolumnRebar_2C = new XYZ(columnProperty.ColumnSectionHeight / 2 - coverDistance - secondMainBarDiam / 2, 0, 0);
                        ...
                        XYZ newPlaсeСolumnRebar_3C = new XYZ(0, -columnProperty.ColumnSectionWidth / 2 + coverDistance + secondMainBarDiam / 2, 0);
                        ...
                        XYZ newPlaсeСolumnRebar_4C = new XYZ(0, columnProperty.ColumnSectionWidth / 2 - coverDistance - secondMainBarDiam / 2, 0);
                        ...
                        && squareColumnsReinforcementWPF.SectionChangeChecked == true)
                    {
                        ...
                        XYZ newPlaсemechanicalConnection_2 = new XYZ(-columnProperty.ColumnSectionHeight / 2
                            + coverDistance
                            + firstMainBarDiam / 2
                            + sectionOffset, columnProperty.ColumnSectionWidth / 2
                            - coverDistance
                            - firstMainBarDiam / 2
                            - sectionOffset, 0);
                        ...
                        FamilyInstance mechanicalConnection_1C = doc.Create.NewFamilyInstance(mechanicalConnection_p0L
                            ...
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        XYZ newPlaсemechanicalConnection_1C = new XYZ(-columnProperty.ColumnSectionHeight / 2 + coverDistance + secondMainBarDiam / 2 + sectionOffset, 0, 0);
                        ...
                        FamilyInstance mechanicalConnection_2C = doc.Create.NewFamilyInstance(mechanicalConnection_p0L
                            ...
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        XYZ newPlaсemechanicalConnection_2C = new XYZ(columnProperty.ColumnSectionHeight / 2 - coverDistance - secondMainBarDiam / 2 - sectionOffset, 0, 0);
                        ...
                        FamilyInstance mechanicalConnection_3C = doc.Create.NewFamilyInstance(mechanicalConnection_p0L
                            ...
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        XYZ newPlaсemechanicalConnection_3C = new XYZ(0, -columnProperty.ColumnSectionWidth / 2 + coverDistance + secondMainBarDiam / 2 + sectionOffset, 0);
                        ...
                        FamilyInstance mechanicalConnection_4C = doc.Create.NewFamilyInstance(mechanicalConnection_p0L
                            ...
                            , columnProperty.BaseLevel
                            , StructuralType.NonStructural);
                        XYZ newPlaсemechanicalConnection_4C = new XYZ(0, columnProperty.ColumnSectionWidth / 2 - coverDistance - secondMainBarDiam / 2 - sectionOffset, 0);
                        ElementTransformUtils.MoveElement(doc, mechanicalConnection_4C.Id, newPlaсemechanicalConnection_4C);
                        ElementTransformUtils.RotateElement(doc, mechanicalConnection_4C.Id, rotateLineBase, (column.Location as LocationPoint).Rotation);
                    }

                    //Если преход со сварки в нахлест c изменением сечения колонны выше
                    else if (squareColumnsReinforcementWPF.RebarConnectionOptionName == "radioButton_Mechanical"
                        && squareColumnsReinforcementWPF.OverlapTransitionChecked == true
                        && squareColumnsReinforcementWPF.SectionChangeChecked == true)
                    {
                        ...
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_2A.Id, rotateLine, -alphaSecondOverlapping);
                        ElementTransformUtils.RotateElement(doc, columnMainRebar_2A.Id, rotateLine2, 180 * (Math.PI / 180));
                        XYZ newPlaсeСolumnRebar_2A = new XYZ(columnProperty.ColumnSectionHeight / 2
                            - coverDistance
                            - secondMainBarDiam / 2
                            , -firstLowerRebarOffset, 0);
                        ElementTransformUtils.MoveElement(doc, columnMainRebar_2A.Id, newPlaсeСolumnRebar_2A);
